...
var RevealOnScroll = function () {
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function createWaypoints() {
            var that = this; //locating the this var on this context for future usage
            this.itemsToReveal.each(function () {
                var currentItem = this; //locating the this var on this context for future usage
                new Waypoint({
                    element: currentItem,
...
var Modal = function () {
    function Modal() {
        ...
        this.openMopdalButton = (0, _jquery2.default)(".open-modal");
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            this.openMopdalButton.click(this.openModal.bind(this));
            //clicking the x close the modal
